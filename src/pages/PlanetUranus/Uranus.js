        ...
        <Col md={6} className="">
          <Card>
            ...
            <div className="d-grid gap-2 w-100">
              <Button variant="outline-light" className={`text-uppercase ${0 === value && "active"}`} bsPrefix="btn__overview__uranus" onClick={() => setValue(0)}>
                <span className="me-2">01</span>overveiw
              </Button>
              <Button variant="outline-light" className={`text-uppercase ${1 === value && "active"}`} bsPrefix="btn__internal__uranus" onClick={() => setValue(1)}>
                <span className="me-2">01</span>internal structure
              </Button>
              <Button variant="outline-light" className={`text-uppercase ${2 === value && "active"}`} bsPrefix="btn__surface__uranus" onClick={() => setValue(2)}>
