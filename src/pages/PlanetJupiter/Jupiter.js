...
function Jupiter() {
  ...
  const { name, overview, structure, geology, rotation, revolution, radius, temperature, images } = data[4]
        ...
        <Col md={6} className="">
          <Card>
            ...
            <div className="btn__container">
              ...
              <Button variant="outline-light" className={`text-uppercase ${1 === value && "active"}`} bsPrefix="btn__internal__jupiter" onClick={() => setValue(1)}>
                <span className="me-2">01</span>internal structure
              </Button>
              <Button variant="outline-light" className={`text-uppercase ${2 === value && "active"}`} bsPrefix="btn__surface__jupiter" onClick={() => setValue(2)}>
