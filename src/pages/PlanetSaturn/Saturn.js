        ...
        <Col md={6} className="">
          <Card>
            ...
            <div className="btn__container">
              ...
              <Button variant="outline-light" className={`text-uppercase ${1 === value && "active"}`} bsPrefix="btn__internal__saturn" onClick={() => setValue(1)}>
                <span className="me-2">01</span>internal structure
              </Button>
              <Button variant="outline-light" className={`text-uppercase ${2 === value && "active"}`} bsPrefix="btn__surface__saturn" onClick={() => setValue(2)}>
