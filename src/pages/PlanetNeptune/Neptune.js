...
function Neptune() {
  ...
  const { name, overview, structure, geology, rotation, revolution, radius, temperature, images } = data[7]
        ...
        <Col md={6} className="">
          <Card>
            ...
            <div className="d-grid gap-2 w-100">
              ...
              <Button variant="outline-light" className={` ${1 === value && "active"}`} bsPrefix="btn__internal__neptune" onClick={() => setValue(1)}>
                <span className="me-2">01</span>internal structure
              </Button>
              <Button variant="outline-light" className={` ${2 === value && "active"}`} bsPrefix="btn__surface__neptune" onClick={() => setValue(2)}>
